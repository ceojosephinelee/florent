...
class SellerProposalStep2PickupScreen extends ConsumerStatefulWidget {
  const SellerProposalStep2PickupScreen({super.key});

  @override
  ConsumerState<SellerProposalStep2PickupScreen> createState() =>
      _SellerProposalStep2PickupScreenState();
}

class _SellerProposalStep2PickupScreenState
    extends ConsumerState<SellerProposalStep2PickupScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final buyerHint = buyerSlots.isNotEmpty
        ? '📌 구매자가 희망하는 픽업 시간은 ${buyerSlots.join(', ')}이에요.\n가능하다면 해당 시간을 우선 선택해주세요.'
        : '📌 구매자의 희망 픽업 시간 정보를 불러오는 중이에요.';
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text('단 하나의 시간만 선택해 확정 약속으로 제안돼요.',
                    ...
                    Wrap(
                      ...
                      children: _timeSlots.map((time) {
                        final isHighlight = buyerSlots.contains(time);
                    ...
                    Text('* 선택한 시간은 예약 확정 시 약속으로 확정됩니다',
                    ...
                    Container(
                      ...
                      child: Text(
                        ...
                        style: AppTypography.body(
                            fontSize: 11, color: const Color(0xFF8A6B20)),
                      ),
                    ),
                  ],
                ),
              ...
              child: Padding(
                ...
                child: SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: form.isStep2Valid && !_isSubmitting
                        ? _handleSubmit
                        : null,
      ...
      child: Row(
        children: [
          Container(
              ...
              height: 28,
              decoration:
                  const BoxDecoration(shape: BoxShape.circle, color: _sage),
          ...
          Container(
              ...
              height: 28,
              decoration:
                  const BoxDecoration(shape: BoxShape.circle, color: inkColor),
              alignment: Alignment.center,
              child: Text('2',
                  style:
                      AppTypography.mono(fontSize: 11, color: whiteColor))),
        ],
      ),
    );
  }
