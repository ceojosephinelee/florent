                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _SectionCard(
                        title: '구매자 정보',
                        children: [
                          _InfoRow(label: '구매자', value: '${d.buyerNickName} 님'),
                        ],
                      ),
                      ...
                      _SectionCard(
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              Text('최종 금액', style: AppTypography.body(fontSize: 13, fontWeight: FontWeight.w700, color: ink60)),
                              Text(
                                '${_formatPrice(d.price)}원',
                                style: AppTypography.body(fontSize: 16, fontWeight: FontWeight.w700, color: _sage),
                              ),
                            ],
                          ),
                        ],
                          ...
                          Row(
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  color: d.fulfillmentType == 'PICKUP' ? _sageLt : const Color(0xFFF2E8E5),
                                ...
                                child: Text(
                                  ...
                                  style: AppTypography.mono(
                                    ...
                                    color: d.fulfillmentType == 'PICKUP' ? _sage : roseColor,
                                  ),
                                ),
                              ),
                            ],
        ...
        children: [
          GestureDetector(
            ...
            child: Padding(
              ...
              child: Row(
                children: [
                  Text('요청 원문 요약', style: AppTypography.body(fontSize: 13, fontWeight: FontWeight.w700)),
                  const Spacer(),
        ...
        Expanded(
          child: Wrap(
            ...
            children: tags.map((t) => Container(
              padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 3),
              decoration: BoxDecoration(color: creamColor, borderRadius: BorderRadius.circular(4), border: Border.all(color: borderColor)),
